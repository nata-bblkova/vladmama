...
final class Version20260211131554 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE children (
            ...
            INDEX IDX_A197B1BAFE54D947 (group_id), 
            INDEX IDX_A197B1BA10405986 (institution_id), 
        ...
        $this->addSql('CREATE TABLE institution_groups (
            ...
            INDEX IDX_65336B6910405986 (institution_id), 
            PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4'
        );
        $this->addSql('CREATE TABLE institutions (
            name VARCHAR(255) NOT NULL, 
            description VARCHAR(255) NOT NULL, 
