...
final class Version20260215104638 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE promotions (name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, rules LONGTEXT NOT NULL, date_publication DATETIME NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, category_id INT NOT NULL, UNIQUE INDEX UNIQ_EA1B30343DA5256D (image_id), INDEX IDX_EA1B303412469DE2 (category_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
